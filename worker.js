const SOURCES={
  ...
  bls_cpi:"https://api.bls.gov/publicAPI/v1/timeseries/data/CUUR0000SA0",
  bls_employment:"https://api.bls.gov/publicAPI/v1/timeseries/data/CES0000000001",
...
export default{async fetch(req,env){
  ...
  if(u.pathname==="/health")return Response.json({ok:true,service:"macro-fuel-relay",version:"0.2.1"});
  ...
  try{
    const r=await fetch(url,{headers:{"User-Agent":"TRADER-SOTOY-MACRO-FUEL-RELAY/0.2.1"}});
